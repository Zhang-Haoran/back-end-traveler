...
it('locationGetTest is running...', async () => {
    const res = await request.get(`/api/v1/location/5c793331bc99fc1510b846b7`);
...
it('locationUpdateTest is running...', async () => {
  const res = await request.patch(`/api/v1/location/5c793331bc99fc1510b846b7`).send({
    city: 'melbourne',
  });
  expect(res.statusCode).toBe(201);
})
...
it('addTourToLocationTest is running...', async () => {
  const res = await request.post(`/api/v1/location/5c793331bc99fc1510b846b7&55153a8014829a865bbf700d`)
